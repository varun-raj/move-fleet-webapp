...
const sidebarItems: SidebarItem[] = [
  {
    label: "Dashboard",
    href: "/t/[organizationSlug]/dashboard",
    icon: Home,
    isActive: ({ pathname, }) => {
      return pathname === "/t/dashboard";
    }
  },
  {
    label: "Find Jobs",
    href: "/t/[organizationSlug]/find-jobs",
    icon: Truck,
    isActive: ({ pathname }) => {
      return pathname === "/t/find-jobs";
    }
  },
  {
    label: "My Jobs",
  ...
  },
  {
    ...
    icon: Building,
    isActive: ({ pathname }) => {
      return pathname === "/t/vehicles";
    }
  },
  {
    label: "Clearing Agency Partners",
    href: "/t/[organizationSlug]/partners",
    icon: Users,
    isActive: ({ pathname }) => {
      return pathname === "/t/partners";
    }
  },
  {
    label: "Settings",
    href: "/t/[organizationSlug]/settings",
    icon: Settings,
    isActive: ({ pathname }) => {
      return pathname === "/t/settings";
    }
  },
];
